...
const FormulairePlanification: React.FC<Props> = ({ planification, tournees, onSuccess, onCancel, enDuplication }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-2">
        ...
        <Button type="submit" className="bg-green-700 text-white">{planification && !enDuplication ? 'Mettre à jour' : 'Enregistrer'}
</Button>
      </div>
    </form>
  )
