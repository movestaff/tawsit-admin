// PhotoUploaderConducteur.tsx

import React, { useRef, useState } from 'react'
import { Button } from './ui/button'
import { toast } from 'react-toastify'
import { uploadPhotoConducteur } from '../lib/api'
...
const PhotoUploaderConducteur: React.FC<Props> = ({ conducteurId, onPhotoUploaded }) => {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setLoading(true)
    try {
      const photoPath = await uploadPhotoConducteur(conducteurId, file)
...
export default PhotoUploaderConducteur
